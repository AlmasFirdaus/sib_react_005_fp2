        ...
        <table className="border w-3/5 divide-y divide-gray-200">
          <thead className="bg-gray-5">
            <tr>
              ...
              <th className="px-6 py-3 text-sm font-bold text-gray-500 uppercase ">Price</th>
              <th className="px-6 py-3 text-sm font-bold text-gray-500 uppercase ">Quantity</th>
              <th className="px-6 py-3 text-sm font-bold text-gray-500 uppercase ">Income</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200">
            <tr>
              <th className="text-left px-3 py-3 text-base font-bold">
                Ini adalah barang <p className="text-left text-gray-500 text-xs">Halo</p>
              </th>

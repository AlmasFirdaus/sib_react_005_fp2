...
const ProductCategory = () => {
  ...
  category = category ? category.replace("-", " ") : "all";

  products = category === "all" ? products : products.filter((product) => product.category === category);
  ...
  return (
    <section className="pt-14 pb-28" id="all-category">
      ...
      <div className="container px-8 md:px-20 font-quicksand flex flex-col justify-center items-center">
